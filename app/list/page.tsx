  ...
  return (
    <main className='px-4 md:px-8 mx-auto max-w-[1550px] w-full '>
      <div className='relative mb-20'>
        ...
        <Image src="https://images.pexels.com/photos/1509534/pexels-photo-1509534.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" width={1500} height={250} alt="background image" className='max-h-[350px] -z-[10]' />
      </div>
    </main>
  )
}
